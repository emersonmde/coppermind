...
/// - At 1024 tokens: 8 heads * 1024² * 4 = ~32MB
/// - At 2048 tokens: 8 heads * 2048² * 4 = ~128MB
/// - At 8192 tokens: 8 heads * 8192² * 4 = ~2GB
///
/// The model supports up to 8192 tokens, but WASM memory limits may require
/// lower values. See `docs/model-optimization.md` for details.
...
impl JinaBertConfig {
    ...
    /// # Returns
    ///
    /// Estimated memory in bytes for ALiBi bias tensor.
